...
const prachi = {
    ...
    passion: ["Backend Architecture", "Real-time Systems", "AI/ML Integration"],
    philosophy: "Programs must be written for people to read, and only incidentally for machines to execute.",
    currentFocus: ["Production-level DMS", "Social Media App - Pragram", "AWS S3 & Authentication"],
    personality: ["Self-confident", "Passionate", "Best Communicator", "Artist", "Kind-hearted"],
...
[![Spotify](https://novatorem-kyzbk7wxl-bardiesel.vercel.app/api/spotify)](https://open.spotify.com/user/31k6rlzwxkjf3gzk4phgphmm6gmi)
...
<!-- Hidden ASCII Art -->
<!--
    ____  ____  ___   ________  ______   ____
   / __ \/ __ \/   | / ____/ / / /  _/  / __ \
  / /_/ / /_/ / /| |/ /   / /_/ // /   / /_/ /
